...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Founded in 2023 by Mr. Deepak Singh, Satya Power Technology's is the authorized INNO distributor for AP & Telangana." },
    ],
  }),
  component: AboutPage,
});
...
const timeline = [
  { year: "2023", title: "Founded", body: "Satya Power Technology's established under the leadership of Mr. Deepak Singh." },
      ...
      <section className="py-20 bg-brand-black text-white">
        <div className="mx-auto max-w-7xl container-px grid md:grid-cols-[280px_1fr] gap-10 items-center">
          ...
          <div>
            ...
            <p className="mt-5 text-white/80 max-w-2xl">A telecom industry veteran, Mr. Deepak Singh founded Satya Power Technology's in 2023 with a simple belief: customers deserve more than a sale — they deserve genuine service. Under his leadership, Fujitomo became the authorized INNO distributor for both states and the only in-region authorized service center.</p>
          </div>
        </div>
      </section>
