        ...
        <div className="relative mx-auto max-w-7xl container-px grid lg:grid-cols-5 gap-10 items-center">
          <div className="lg:col-span-3">
            ...
            <p className="mt-5 text-base md:text-lg text-muted-foreground max-w-xl">
              SATYA POWER TECHNOLOGYS is the authorized distributor of INNO Instrument across Andhra Pradesh and Telangana — covering full sales, service and warranty support.
            </p>
