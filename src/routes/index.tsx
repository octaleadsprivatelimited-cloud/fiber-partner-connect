    ...
    <>
      ...
      <section className="py-10 md:py-28 bg-white">
        <div className="mx-auto max-w-7xl container-px">
          <div className="grid md:grid-cols-3 gap-6 mb-8 md:gap-10 md:mb-16 items-end">
            <div className="md:col-span-2">
              <div className="text-[11px] font-bold tracking-[0.22em] text-primary mb-3 md:mb-4">FEATURED PRODUCTS</div>
              <h2 className="text-2xl md:text-5xl font-black text-brand-black leading-[1.05]">Top picks from our catalogue</h2>
            </div>
